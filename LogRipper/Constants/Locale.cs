...
namespace LogRipper.Constants
{
    internal static class Locale
    {
        ...
        public static string TITLE_NEW_RULE { get; set; }
        public static string TITLE_EDIT_RULE { get; set; }
        ...
        public static string TITLE_LIST_RULES { get; set; }
        public static string TITLE_MERGE_FILE { get; set; }
        ...
        public static string TITLE_SEARCH { get; set; }
        public static string LBL_SEARCH_TEXT { get; set; }
        public static string TITLE_GOTO { get; set; }
        ...
        public static string TITLE_SETTINGS { get; set; }
