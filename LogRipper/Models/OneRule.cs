...
{
    [XmlRoot()]
    public class OneRule : RuleViewModelBase
    {
        private bool _active;
        private readonly ICommand _cmdDelete;
        private readonly ICommand _cmdEdit;
        ...
        public OneRule() : base()
        {
            ...
            _active = true;
            _cmdDelete = new RelayCommand((param) => DeleteThisRule());
        ...
        [XmlElement()]
        public List<OneSubRule> SubRules
        {
        ...
        internal override bool Execute(string line, DateTime dateline)
        {
            ...
            if (_subRules.Count > 0)
                foreach (OneSubRule rule in _subRules)
                {
